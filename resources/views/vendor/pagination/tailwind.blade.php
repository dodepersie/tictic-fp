                ...
                <span class="flex justify-center gap-1 text-xs font-medium">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span
                                class="inline-flex size-8 items-center justify-center rounded border border-gray-300 bg-gray-200 text-gray-700 rtl:rotate-180"
                                aria-hidden="true">
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="block size-8 rounded border-slate-900 bg-slate-900 text-center leading-8 text-white">{{ $page }}</span>
                                    </span>
                                @else
                                    <a href="{{ $url }}"
