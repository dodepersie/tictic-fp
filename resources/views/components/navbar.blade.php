<header class="fixed bg-white w-full shadow border z-10">
            ...
            <div class="relative md:flex md:items-center md:gap-4" x-data="{ showDropdown: false }">
                ...
                <nav aria-label="Global" class="hidden md:block">
                    <ul class="flex items-center gap-4 text-sm">
                        <li>
                            <a class="text-gray-500" href="/about">
                                About </a>
                        </li>

                        <li>
                            <a class="text-gray-500" href="{{ route('event.index') }}"> Tickets </a>
                        </li>

                        @guest
                            <li>
                                <a class="hover:underline" href="{{ route('register_merchant') }}">
                                    Become TicTic
                                    Partner </a>
                            </li>
                        @endguest
